\subsection{Convergence of the discretized flow in space and time}
...
\begin{proposition}\aknote{so these are rates for the mmd algorithm, which can be stuck in practice. not sure to what extent they apply to the noisy}
	%\label{prop:sample_based_rates}
