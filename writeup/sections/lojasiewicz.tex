...
\begin{proposition}\label{prop:lojasiewicz}
	...
	\end{align}
\end{proposition}
The fact that \cref{eq:neg_sobolev} appears in the context of Wasserstein flows is not a coincidence. Indeed, \cref{eq:neg_sobolev} is a linearization of the Wasserstein distance \cite{Peyre:2011,Otto:2000}. In fact, gradient flows of $\F$ defined under different metrics, would involves other kinds of distances instead of \cref{eq:neg_sobolev}. 
