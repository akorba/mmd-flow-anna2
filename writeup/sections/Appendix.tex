...
\begin{lemma}\label{lem:derivative_mmd_augmented}\manote{Notations still needs to be adjusted in this lemma}\manote{State assumption on bounded hessian}
...
\]
Using the definition
of $\rho_{t}=(I+t\phi)_{\#}q$ we can write:\aknote{$\pi_t$? guess this corresponds to the paragraph below} \manote{use the proposition giving the time derivative of witness}
\[
