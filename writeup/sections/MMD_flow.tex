...
\section{Convergence properties of the continuous time MMD flow}\label{sec:convergence_mmd_flow}

In this section, we investigate the convergence properties of the continuous time MMD flow. We characterize the speed of convergence, but we also show that since the flow only satisfies a weak notion of convexity with respect to the $W_2$ metric, it is only guaranteed to converge to a local minima. 
