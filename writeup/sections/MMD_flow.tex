...
We remark on a claim that  KSD flow converges globally, (recall that KSD is related to MMD) \cite[Prop. 3, Appendix B.1]{Mroueh:2019}. This  requires an assumption \cite[Assump. A]{Mroueh:2019} that amounts to assuming that equilibria satisfying \cref{eq:equilibrium_condition} do not exist \aknote{ref to appendix}.\aknote{sentence not correct}
