...
Note that the regularised Kernel Sobolev Discrepancy does not exhibit teleportation, however the global convergence claim of \cite[Proposition 3, Appendix B.1]{Mroueh:2019} requires an assumption \cite[Assumption A]{Mroueh:2019} that amounts to assuming that the algorithm is not in a local minimum.\agnote{add a short appendix section.}
